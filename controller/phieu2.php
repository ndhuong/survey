...
$kiemtra_sql="SELECT ks_id,ks_so_phieu,ks_nha_hang FROM khao_sat WHERE (ks_so_phieu=".$sophieu.")";
	...
	if(count($res)>0)
		{
			...
			if($res['ks_nha_hang']>0){
				
				echo '<br><font color=red><b> Đã có số phiếu này rồi, hãy chọn số phiếu khác</b></font><input type="hidden" name="phieuok" value="-1"> <br> <a href="./index.php?ylan=phieu_nhahang&sua='.$new_id.'"> Bấm vào đây để sửa phiếu này</a>';
			}
			else{
